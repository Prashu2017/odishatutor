...
class Tutor extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['firstname', 'lastname', 'phone', 'dob', 'gender', 'subjects', 'expertise_subject', 'experience', 'professional', 'geographically_present', 'available_for', 'pricing', 'language', 'expertise_course', 'digital_pen', 'describe_you', 'country_id', 'state_id', 'city_id', 'pincode', 'street_address', 'website', 'previous_work_place'], 'required'],
            [[  'experience', 'digital_pen', 'created_by', 'created_at', 'updated_by', 'updated_at'], 'integer'],
            [['dob'], 'safe'],
            [['firstname', 'lastname', 'phone', 'gender', 'image', 'subjects', 'professional', 'pricing', 'language','country_id', 'state_id', 'city_id',  'pincode', 'street_address', 'website', 'previous_work_place'], 'string', 'max' => 255],
            [['age'], 'string', 'max' => 50],
            [['describe_you'], 'string'],
        ];
    }
    ...
    public function beforeSave($insert) {
        ...
        if ($insert) {
            ...
            // $this->geographically_present = implode("," , $model->geographically_present);
            // $this->available_for = implode("," , $model->available_for);
            // $this->expertise_course = implode("," , $model->expertise_course);
