  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
         <h3><?= $model->name ?></h3>
          <p class="lead">Your Request to <?= $model->subject ?> tuition successfully submitted. We will get back to you soon with a expert techer of subject you requested!</p>
