...
<header class="main-header">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button">
            ...
            <h1><a class="navbar-brand" href="index.php"><i class="fa fa-leanpub" aria-hidden="true"></i><?//= $model->site_name; ?></a></h1>
            ...
            <ul class="agile_forms">
                ...
                {
                //     echo '<li>'. Html::beginForm(['/site/logout'], 'post'). Html::submitButton(
                // 'Logout (' . Yii::$app->user->identity->username . ')', ['class' => 'btn btn-link logout']). Html::endForm(). '</li>';
                
                    // echo '<li>'. Html::a('Complete Profile', ['tutor/create'], ['class'=>'modal-form']).'</li>';
                }
                ?>
                <li>hello</li>
            </ul>
